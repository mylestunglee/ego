...
The implementation of knowledge transfer follows the algorithm below. For the full details, see \path{transferrer.cpp}. We use $10n_T$ samples to learn about $T$, by using $5n_T$ configurations from $S$ to sample $T$ and $5n_T$ configurations from LHS in the EGO algorithm. 
\begin{figure}[H]
	\begin{framed}
		\begin{algorithm}[H]
...
\begin{figure}[H]
	 \begin{center}
		\subfigure[robot]{
			\includegraphics[width=0.45\textwidth]{images/robot_fitness.png}
		}
		\subfigure[stochastic]{
			\includegraphics[width=0.45\textwidth]{images/stochastic_fitness.png}
		}
		...
		\subfigure[genomics Max3 oversample=0]{
			\includegraphics[width=0.45\textwidth]{images/genomics_max3_oversample_0_plot.png}
		}
		\subfigure[genomics Max3 oversample=1]{
			\includegraphics[width=0.45\textwidth]{images/genomics_max3_oversample_1_plot.png}
		}
		\subfigure[genomics Max4 oversample=0]{
			\includegraphics[width=0.45\textwidth]{images/genomics_max4_oversample_0_plot.png}
		}
		\subfigure[genomics Max4 oversample=1]{
			\includegraphics[width=0.45\textwidth]{images/genomics_max4_oversample_1_plot.png}
		}
	\end{center}
...
\begin{figure}[H]
	 \begin{center}
		\subfigure[robot to stochastic]{
			\includegraphics[width=0.45\textwidth]{cropped_robot_stochastic_transfer.png}
		}
		\subfigure[stochastic to robot]{
			\includegraphics[width=0.45\textwidth]{cropped_stochastic_robot_transfer.png}
		}
		\subfigure[quadrature Max3 to Max4]{
			\includegraphics[width=0.45\textwidth]{cropped_quadrature_max3_quadrature_max4_transfer.png}
		}
		...
		\subfigure[xinyu rtm Max3 to Max4]{
			\includegraphics[width=0.45\textwidth]{cropped_xinyu_rtm_max3_xinyu_rtm_max4_transfer.png}
		}
	\end{center}
