...
The program is written in C++ 14. Each design mentioned in the evaluation section can be found in the \path{examples} directory. The program has the dependencies: \path{Catch}, \path{eigen}, \path{gsl} and \path{libgp}.
